...
def test_1_0():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/one_0.png"
    )[:, :, 0]
...
def test_1_1():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/one_1.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_2_0():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/two_0.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_2_1():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/two_1.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_3_0():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/three_0.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_3_1():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/three_1.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_4():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/four.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_5():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/five.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_6():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/six.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_7():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/sevent.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_8():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/eight.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_9():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/nine.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
...
def test_10():
    ...
    #  Load image.
    image = cv.imread(
        "../Number-Recognition-APP/model/test/paint_images/ten.png"
    )[:, :, 0]
    #  Convert the image to a numpy array and invert it.
    image = np.invert(np.array([image]))
    #  Request the model prediction.
